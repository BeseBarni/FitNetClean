...
namespace FitNetClean.Infrastructure.Extensions;
...
public static class MigrationExtensions
{
    ...
    public static async Task<bool> WaitForDatabaseAsync(this IServiceProvider serviceProvider, int maxRetries = 30, int delaySeconds = 2)
    {
        using var scope = serviceProvider.CreateScope();
        var context = scope.ServiceProvider.GetRequiredService<FitNetContext>();
